...
void test0(void)
{
  ...
  boat.orientation = CS170::WarBoats::O_HORIZONTAL;
  bp = ocean.PlaceBoat(boat);
  if (bp == CS170::WarBoats::BP_REJECTED)
  ...
  location.y = 1;
  boat.position = location;
  boat.orientation = CS170::WarBoats::O_VERTICAL;
  bp = ocean.PlaceBoat(boat);
  if (bp == CS170::WarBoats::BP_REJECTED)
    std::cout << "Boat placement is rejected." << std::endl;
  else
...
int main(int argC, const char** argV)
{
  ...
  case 3:
    ...
    break;
  default:
    std::cout << "Test should be 0 - 3" << std::endl;
    break;
  }
